		...
		<section class="search__container">
			...
			<div class="kubun__div">
				...
				<select class="filter__options">
					...
					<option value="">ANGIOGTAPHY(혈관조영)</option>
			...
			<div class="threeGrid__container roomGrid">
				<div class="twoGrid__container threeGrid__container-subcontainer">
					...
					<div class="grid__title">
						...
						<div class="room__Div">
							<p>촬영실</p>
							<select class="room__Class" disabled="disabled">
								<option>DR1</option>
								<option>CT실1</option>
								<option>ct2</option>
								<option>MRI실1</option>
						...
						<div class="btn__container">
							<button
								class="all__btn img__btn fontawesome__btn fileCheck__icon ">접수</button>
							<button
								class="all__btn img__btn fontawesome__btn calenderCheck__icon ">예약</button>
							<button
								class="all__btn img__btn fontawesome__btn fileXmark__icon ">취소</button>
						</div>
					</div>
					<!-- 그리드 -->
				...
				<div class="twoGrid__container threeGrid__container-subcontainer">
					...
					<div class="reservation__div">
						<p class="reservation__keyword">검사예약현황</p>
									...
									.jqGrid(
											{
												...
												onSortCol : function(index,
													...
													var $icons = $(
															this.grid.headers[idxcol].el)
															.find(
																	">div.ui-jqgrid-sortable>span.s-ico");
													if (this.p.sortorder === "asc") {
														//$icons.find('>span.ui-icon-asc').show();
														$icons
																.find(">span.ui-icon-asc")[0].style.display = "";
														$icons
																.find(">span.ui-icon-asc")[0].style.marginTop = "1px";
														$icons
																.find(
																		">span.ui-icon-desc")
																.hide();
														...
														$icons
																.find(">span.ui-icon-desc")[0].style.display = "";
														$icons
																.find(
																		">span.ui-icon-asc")
																.hide();
