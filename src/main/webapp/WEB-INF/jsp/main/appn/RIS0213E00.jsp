  ...
  <body>
    <main class="main__container">
      ...
      <section class="search__container">
        ...
        <button id="search-btn" class="all__btn  search__btn ma_left_1 tooltip"><spring:message code="text_054" text="검색" />
        ...
        <div class="btn__container">
        	...
        	<c:choose>
				    <c:when test="${sessionScope.user_grade eq 'S' || sessionScope.user_grade eq 'A' || sessionScope.user_grade eq 'D'}">
						<button id="update-btn" class="all__btn  update__btn"><spring:message code="text_214" text="수정" /></button>
			        	<button id="input-btn" class="all__btn  insert__btn"><spring:message code="text_213" text="입력" /></button>
					    <button id="delete-btn" class="all__btn  delete__btn"><spring:message code="text_215" text="삭제" /></button>
      ...
      $(document).ready(function () {
        ...
        $("#list1").jqGrid({
          ...
          colModel: [
            ...
            { name: "mddlKrNm", index: "mddlKrNm", width: 50, align: "left",  editable:true, edittype: 'select',  editoptions: { value:selectOption } },	
            {
              name: "strtDate",
              index: "strtDate",
              width: 50,
            ...
            { name: "strtTime", index: "strtTime", width: 50, align: "center", editable:true, edittype:'text',  editoptions: {type: "time"}},
            { name: "endTime", index: "endTime", width: 50, align: "center", editable:true, edittype:'text', editoptions: {type: "time"} },
            { name: "appnImpsText", index: "appnImpsText", width: 100, align: "left", editable:true, edittype:'text' },
