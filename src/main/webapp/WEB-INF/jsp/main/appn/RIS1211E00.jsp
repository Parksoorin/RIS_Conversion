 ...
 //       initialDate: '2021-07-15', // 초기 날짜 설정 (설정하지 않으면 오늘 날짜가 보인다.)
      ...
      calendar.render();
        ...
        $("#list1").jqGrid({
          ...
          colModel: [
        	{ name: "appnYn", index: "appnYn", width: 30, align: "center"},
            { name: "pmntYn", index: "pmntYn", width: 30, align: "center"},
            {
              name: "ptntKrNm",
              index: "ptntKrNm",
              width: 50,
            ...
            { name: "ordrDate", index: "ordrDate", width: 50, align: "center" },
            { name: "ordrCd", index: "ordrCd", width: 50, align: "left" },
            { name: "ordrNm", index: "ordrNm", width: 100, align: "left" },
            { name: "appnTreatment", index: "appnTreatment", width: 80, align: "left"},
            { name: "docNm", index: "docNm", width: 50, align: "center" }, 
            { name: "gubun", index: "gubun", width: 50, align: "center"},
            { name: "dsrdDate", index: "dsrdDate", width: 50, align: "center"  },
            { name: "dsrdTime", index: "dsrdTime", width: 50, align: "center" },
            { name: "appnDate", index: "appnDate", width: 50, align: "center" },
            { name: "appnTime", index: "appnTime", width: 50, align: "center" },
