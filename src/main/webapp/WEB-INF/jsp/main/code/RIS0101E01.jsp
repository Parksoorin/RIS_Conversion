	...
	<div class="inquiry__page-flex mt5">
		<section class="inquiry__search-section">
			<div class="inquiry__search-flex" style="justify-content:space-between;"> <!-- 1 Row -->
				<div class="box__flex">
					<button class="all__btn img__btn mokrok__btn" onclick="javascript:history.back();">목록</button>
				</div>
				<div class="box__flex">
						...
						onSelectRow: function(rowid) {
							...
							if(iudcheck == 0){
								...
								jQuery('#list2').jqGrid('setGridParam', {
									url: "/risCodeList3.do?hsptId="+params.hsptId+"&lrgcCd="+params.lrgcCd+"&mddlCd="+params.mddlCd,
									postData: {
										checkLMS : "S",
